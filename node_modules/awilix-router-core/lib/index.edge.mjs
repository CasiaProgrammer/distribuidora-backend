...
const findControllers = () => { throw new Error('findControllers is not supported in edge runtimes without filesystem access.') };
...
//# sourceMappingURL=index.edge.mjs.map
